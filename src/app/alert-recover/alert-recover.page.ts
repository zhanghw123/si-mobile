...
@Component({
  selector: 'app-alert-recover',
  templateUrl: './alert-recover.page.html',
  styleUrls: ['./alert-recover.page.scss'],
})
export class AlertRecoverPage implements OnInit {
